class Networkit < Formula
  ...
  url "https://github.com/networkit/networkit.git",
      tag: "7.1", revision: "4c6dcc4367b51005a34221242048609c357ffbd6"
  ...
  def install
    ...
    system Formula["python@3.8"].opt_bin/"pip3", "install", "cython"
    system Formula["python@3.8"].opt_bin/"python3", "setup.py", "build_ext", "--networkit-external-core",
           "--rpath=@loader_path;#{rpath_addons}"
    system Formula["python@3.8"].opt_bin/"python3", "setup.py", "install", "--single-version-externally-managed",
           "--record=installed.txt", "--prefix=#{libexec}"
